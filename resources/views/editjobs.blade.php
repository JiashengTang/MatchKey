...
@section('content')
  ...
  <div class="py-5">
    <h2>Edit Job</h2>
    <p class="lead">Please change the details and Cilck Complete Button to finish the Edit function</p>
  </div>
  {!! Form::open(['url'=> 'editjobs/submit'])!!}
    <div class="col-md-8 order-md-1">
      ...
      <form class="needs-validation" novalidate>
        ...
        <div class="row">
            ...
            {{Form::select('experience', array('0 years' => '0 years', '1-2 years' => '1-2 years','2-5 years' => '2-5 years','5+ years' =>'5+ years'), $U->experience,['class'=>'custom-select d-block w-100'])}}
            </div>
        </div>
        ...
        <div class="row">
            ...
            {{Form::label('salaryrange','Salary')}}<span class="text-muted">/month</span>
			      {{Form::number('salaryrange',$U->salaryrange,['class'=> 'form-control','placeholder'=>'/month', 'min'=>'0'])}}
            </div>
        </div>
        ...
        <hr class="mb-4">
        {{Form::submit('Complete Edit',['class'=>'btn btn-primary'])}}
      </form>
      @endforeach
    @endif
      {!!Form::close()!!}
